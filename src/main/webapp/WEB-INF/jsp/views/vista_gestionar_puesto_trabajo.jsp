...
<html>
    <head>
        ...
        <title>Gestion de Puestos de Trabajos</title>
                ...
                <div class="col-10">
                    <div class="d-flex row gap-3 justify-content-center">
                        <div class="col-12 mt-3 p-4">
                            <h5 class="fw-bold">Gestionar Puestos de Trabajo<span class="badge badge-secondary"></span></h5>

                            <form id="puestoTrabajo-form-register">
                                
                                <div class="row mt-4 justify-content-center">
                                    
                                    <div class="col-md-2">
                                        <label for="lblPuestoTrabajo" class="form-label fw-bold">Puesto de Trabajo:</label>
                                        <input type="text" name="puesto" id="puesto" autocomplete="off" class="form-control">
                                    </div>

                                    <div class="col-md-3">
                                        <label for="lblEstadoPuestoTrabajo" class="form-label fw-bold">Estado:</label>
                    ...
                    <div class="row justify-content-center">
                        <div class="d-flex col-6 mt-4">
                            <table class="table table-striped text-center">
                                ...
                                <tbody id="table-puestoTrabajo-list">
