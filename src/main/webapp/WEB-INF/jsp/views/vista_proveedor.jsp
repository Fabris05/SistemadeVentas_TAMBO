                ...
                <div class="col-10">
                    <div class="d-flex row g-3 justify-content-center">
                        <div class="row mt-3 p-4">
                            <h5 class="fw-bold">Buscar Proveedor<span class="badge badge-secondary"></span></h5>

                            <!--Form para Buscar-->
                            <form id="proveedor-form-search">
                            ...
                            <div class="d-flex col justify-content-end gap-3 me-3" > 
                                ...
                                <div class="">
                                    <a class="btn btn-secondary" href="/proveedores/save" role="button" style="display: flex; align-items: center;">
                            ...
                            <div class="mt-4">
                                <table class="table table-striped text-center mt-3">
                                    ...
                                    <tbody id="table-proveedores-list">
